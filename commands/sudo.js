...
async function sudoCommand(sock, chatId, message) {
    ...
    if (!targetJid) {
        await sock.sendMessage(chatId, { text: '👤 *Mencione um usuário!*\n\n📝 *Como usar:*\n• Mencione: .sudo add @usuario\n• Ou responda a mensagem dele\n\n💡 *Dica:* Use .sudo list para ver sudos atuais\n\n✨ *Yen-Bot* - Gerenciamento de permissões! 🌸' },{quoted :message});
        return;
    }
