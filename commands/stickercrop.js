...
async function stickercropCommand(sock, chatId, message) {
    ...
    if (!mediaMessage) {
        await sock.sendMessage(chatId, { 
            text: '🌸 *Como usar o Crop:*\n\n• Responda a uma imagem/vídeo/sticker com .crop\n• Ou envie uma imagem/vídeo/sticker com .crop na legenda\n\n💡 *Dica:* Funciona melhor com imagens quadradas\n\n✨ *Yen-Bot* - Cortando com precisão! 🌸',
            contextInfo: {
                forwardingScore: 999,
                isForwarded: true,
            }
    ...
    try {
        ...
        await sock.sendMessage(chatId, { 
            text: '❌ *Falha ao cortar figurinha!*\n\n🔄 *Possíveis causas:*\n• Formato não suportado\n• Arquivo corrompido\n• Erro de processamento\n\n💡 *Dicas:*\n• Tente com uma imagem\n• Use formatos JPG ou PNG\n• Verifique se o arquivo não está corrompido\n\n✨ *Yen-Bot* - Otimizando figurinhas! 🌸',
            contextInfo: {
                forwardingScore: 999,
                isForwarded: true,
            }
