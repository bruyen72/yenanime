...
async function songCommand(sock, chatId, message) {
    try {
        ...
        if (!searchQuery) {
            return await sock.sendMessage(chatId, { text: '🎵 *Como usar Download de Música:*\n\n• Digite: .song <nome da música ou link>\n\n📝 *Exemplos:*\n• .song shape of you\n• .song https://youtube.com/watch?v=...\n\n🎯 *Formatos suportados:* YouTube\n📱 *Qualidade:* 128kbps MP3\n\n✨ *Yen-Bot* - Suas músicas favoritas! 🌸' }, { quoted: message });
        }
        ...
        if (searchQuery.startsWith('http://') || searchQuery.startsWith('https://')) {
            ...
            if (!videos || videos.length === 0) {
                return await sock.sendMessage(chatId, { text: '😅 *Nenhuma música encontrada!*\n\n🔍 *Dicas para melhorar a busca:*\n• Use nome do artista + música\n• Tente termos em inglês\n• Seja mais específico\n\n💡 *Exemplo:* .song Ed Sheeran Shape of You\n\n✨ *Yen-Bot* - Sempre procurando! 🌸' }, { quoted: message });
            }
        ...
        try {
            ...
            return await sock.sendMessage(chatId, { text: '🌧️ *Erro nas APIs!*\n\n❌ *Todas as opções falharam*\n🔄 *Tente novamente mais tarde*\n\n💡 Servidores podem estar sobrecarregados\n\n✨ *Yen-Bot* - Persistindo sempre! 🌸' });
                }
            }
        }
        ...
        if (!result || !result.status || !result.result || !result.result.download) {
            ...
            return await sock.sendMessage(chatId, { text: '🔗 *Link inválido recebido!*\n\n❌ *API retornou dados incorretos*\n🔄 *Tentando método alternativo...*\n\n💡 O vídeo pode ter restrições\n\n✨ *Yen-Bot* - Buscando soluções! 🌸' }, { quoted: message });
        }
        ...
        try {
            ...
            return await sock.sendMessage(chatId, { text: '🌐 *Erro de rede!*\n\n❌ *Falha na conexão com servidor*\n🔄 *Verifique sua internet*\n\n💡 *Dicas:*\n• Aguarde alguns minutos\n• Tente música diferente\n\n✨ *Yen-Bot* - Conectando sempre! 🌸' }, { quoted: message });
        }
        ...
        if (response.status < 200 || response.status >= 300) {
            ...
            return await sock.sendMessage(chatId, { text: '📡 *Servidor indisponível!*\n\n❌ *Status de erro do servidor*\n🔄 *Tentando servidor alternativo...*\n\n💡 Alguns vídeos podem estar bloqueados\n\n✨ *Yen-Bot* - Procurando alternativas! 🌸' }, { quoted: message });
        }
        ...
        if (!fileSize || fileSize < 10240) { // <10KB indicates failure
            return await sock.sendMessage(chatId, { text: '📁 *Arquivo corrompido!*\n\n⚠️ *O arquivo baixado está muito pequeno*\n🔄 *Isso indica falha no download*\n\n💡 *Tente:*\n• Música diferente\n• Aguardar alguns minutos\n\n✨ *Yen-Bot* - Garantindo qualidade! 🌸' }, { quoted: message });
        }
        ...
        await sock.sendMessage(chatId, { text: '💥 *Falha geral no download!*\n\n❌ *Erro interno do sistema*\n🔄 *Tente novamente em alguns minutos*\n\n🛠️ *Se persistir:*\n• Reinicie o bot\n• Teste outra música\n• Verifique sua conexão\n\n✨ *Yen-Bot* - Resolvendo problemas! 🌸' }, { quoted: message });
    }
}
