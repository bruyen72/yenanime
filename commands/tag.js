...
async function tagCommand(sock, chatId, senderId, messageText, replyMessage, message) {
    ...
    if (!isBotAdmin) {
        await sock.sendMessage(chatId, { text: '🤖 *Preciso ser admin primeiro!*\n\n👑 Para usar comandos de marcação, me promova a administrador do grupo.\n\n✨ *Yen-Bot* - Mencionar todos! 🌸' }, { quoted: message });
        return;
    }
    ...
    if (replyMessage) {
        ...
        await sock.sendMessage(chatId, {
            text: messageText || "📣 *Mensagem para todos!*\n\n👥 Todos foram marcados\n\n✨ *Yen-Bot* - Comunicação eficiente! 🌸",
            mentions: mentionedJidList
        });
    }
}
