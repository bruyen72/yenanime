...
async function textmakerCommand(sock, chatId, message, q, type) {
    try {
        if (!q) {
            return await sock.sendMessage(chatId, messageTemplates.error("Por favor forneça o texto para gerar\nExemplo: .metallic Nick"));
        }
        ...
        try {
            ...
            switch (type) {
                ...
                case 'fire':
                    ...
                    break;
                default:
                    return await sock.sendMessage(chatId, messageTemplates.error("Tipo de gerador de texto inválido"));
            }
